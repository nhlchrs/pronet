                    ...
                    <div className="d-flex flex-column gspace-3">
                        <div className="card" style={{ padding: '40px', backgroundColor: '#ffffff' }}>
                            <div style={{ maxWidth: '900px', margin: '0 auto' }}>
                                <h1 style={{ marginBottom: '20px', color: '#2c3e50' }}>User Agreement</h1>
                                ...
                                <div style={{ marginBottom: '30px' }}>
                                    ...
                                    <p style={{ lineHeight: '1.8', marginTop: '15px', fontWeight: '600', color: '#2c3e50' }}>
                                        If you do not agree, you must not use our services.
                                    </p>
                                </div>

                                <div style={{ marginBottom: '30px' }}>
                                    <h2 style={{ marginBottom: '15px', color: '#2c3e50' }}>1. Purpose of the Agreement</h2>
                                    <p style={{ lineHeight: '1.8', color: '#2c3e50' }}>
                                ...
                                <div style={{ marginBottom: '30px' }}>
                                    <h2 style={{ marginBottom: '15px', color: '#2c3e50' }}>2. Educational Relationship Only</h2>
                                    <p style={{ lineHeight: '1.8', color: '#2c3e50' }}>You acknowledge and agree that:</p>
                                ...
                                <div style={{ marginBottom: '30px' }}>
                                    <h2 style={{ marginBottom: '15px', color: '#2c3e50' }}>3. Acknowledgment of Risk</h2>
                                    <p style={{ lineHeight: '1.8', color: '#2c3e50' }}>You expressly acknowledge that:</p>
                                    <ul style={{ lineHeight: '1.8', paddingLeft: '25px', marginTop: '10px', color: '#2c3e50' }}>
                                ...
                                <div style={{ marginBottom: '30px' }}>
                                    <h2 style={{ marginBottom: '15px', color: '#2c3e50' }}>4. No Guarantee of Results</h2>
                                    <p style={{ lineHeight: '1.8', color: '#2c3e50' }}>
                                ...
                                <div style={{ marginBottom: '30px' }}>
                                    <h2 style={{ marginBottom: '15px', color: '#2c3e50' }}>5. User Responsibilities</h2>
                                    <p style={{ lineHeight: '1.8', color: '#2c3e50' }}>You agree to:</p>
                                    <ul style={{ lineHeight: '1.8', paddingLeft: '25px', marginTop: '10px', color: '#2c3e50' }}>
                                ...
                                <div style={{ marginBottom: '30px' }}>
                                    <h2 style={{ marginBottom: '15px', color: '#2c3e50' }}>7. Payments & Access</h2>
                                ...
                                <div style={{ marginBottom: '30px' }}>
                                    <h2 style={{ marginBottom: '15px', color: '#2c3e50' }}>8. Technology & Platform Limitations</h2>
                                    <p style={{ lineHeight: '1.8', color: '#2c3e50' }}>You acknowledge that:</p>
                                    <ul style={{ lineHeight: '1.8', paddingLeft: '25px', marginTop: '10px', color: '#2c3e50' }}>
                                ...
                                <div style={{ marginBottom: '30px' }}>
                                    <h2 style={{ marginBottom: '15px', color: '#2c3e50' }}>9. Suspension & Termination</h2>
                                    <p style={{ lineHeight: '1.8', color: '#2c3e50' }}>
                                ...
                                <div style={{ marginBottom: '30px' }}>
                                    <h2 style={{ marginBottom: '15px', color: '#2c3e50' }}>10. Limitation of Liability</h2>
                                    <p style={{ lineHeight: '1.8', color: '#2c3e50' }}>
                                ...
                                <div style={{ marginBottom: '30px' }}>
                                    <h2 style={{ marginBottom: '15px', color: '#2c3e50' }}>11. Indemnification</h2>
                                    <p style={{ lineHeight: '1.8', color: '#2c3e50' }}>
                                ...
                                <div style={{ marginBottom: '30px' }}>
                                    <h2 style={{ marginBottom: '15px', color: '#2c3e50' }}>12. Modifications to Agreement</h2>
                                    <p style={{ lineHeight: '1.8', color: '#2c3e50' }}>
                                ...
                                <div style={{ marginBottom: '30px' }}>
                                    <h2 style={{ marginBottom: '15px', color: '#2c3e50' }}>14. Severability</h2>
                                    <p style={{ lineHeight: '1.8', color: '#2c3e50' }}>
                                ...
                                <div style={{ marginBottom: '30px' }}>
                                    <h2 style={{ marginBottom: '15px', color: '#2c3e50' }}>15. Acceptance of Agreement</h2>
                                    <p style={{ lineHeight: '1.8', color: '#2c3e50' }}>
